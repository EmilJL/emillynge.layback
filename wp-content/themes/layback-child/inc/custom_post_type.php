<?php
	...
	// add_action( 'init', 'lb_posttype_' );
	// function lb_posttype_() {
	   
	//    // Write these variables as all lowercase

	// 	// Post variables
	// 	$singular 				= __('custom_name', 'layback');
	// 	$multiple 				= __('custom_name', 'layback');
	// 	$description 			= __( 'This is a default post_type description', 'layback' );
	// 	$single_slug 			= $singular;
	// 	$archive_slug 			= $multiple;
	// 	$menu_name 				= $multiple;
	// 	$post_type_name 		= 'custom_name';
